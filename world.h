...
struct World {
  ...
  std::vector<Hitable*> lights; // TODO: For shadow rays later on
  BVHNode* bvh;
  ...
  void default_scene() {
    ...
    hitables.push_back(new Sphere{Vec3<>{0.5, 0.5, -2.5}, 0.2, new Emission{new ConstantTexture{1.0, 1.0, 1.0}}});
  ...
  void cornell_box() {
    auto checker_texture = new CheckerTexture{new ConstantTexture{0.2, 0.3, 0.1}, new ConstantTexture{0.9, 0.9, 0.9}};
    hitables.push_back(new Sphere{Vec3<>{0, -1000, -1}, 100, new Lambertian{checker_texture}});
  ...
  void simple_light_scene() {
    ...
    hitables.push_back(new Sphere{Vec3<>{0, 2, 0}, 2, new Lambertian{pertext}});
    hitables.push_back(new Sphere{Vec3<>{0, 7, 0}, 2, new Emission{new ConstantTexture{4, 4, 4}}});
    hitables.push_back(new Rectxy{3, 5, 1, 3, -2, new Emission{new ConstantTexture{4, 4, 4}}});
  }
};
